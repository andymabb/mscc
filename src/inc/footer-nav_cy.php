<div class="footer-nav-wrap">
    <ul class="footer-nav nav">
        <li class="<?php if($page=='index_cy.php'){echo 'active';}?>">
        <a href="index_cy.php">Cartref</a>
        </li>
        <li class="<?php if($page=='documents_cy.php'){echo 'active';}?>">
        <a href="documents_cy.php">Dogfennau</a>
        </li>
        <li class="<?php if($page=='planning_cy.php'){echo 'active';}?>">
        <a href="planning_cy.php">Cynllunio</a>
        </li>
