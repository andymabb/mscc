...
<li class="<?php if($page=='documents.php'){echo 'active';}?>">
<a href="documents.php">Documents</a>
</li>
<li class="<?php if($page=='planning.php'){echo 'active';}?>">
<a href="planning.php">Planning <span class="small-hide">Matters</span></a>
</li>
