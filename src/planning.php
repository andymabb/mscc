...
<meta name="description" content="Local planning permission applications and decisions">
...
<div class="nav-wrap">
	...
	<li class="switch"><a href="planning_cy.php">Cymraeg</a></li>
	</ul>
</div>

<main class="main" id="main">
<h2 class="page-title">Planning Applications</h2>
